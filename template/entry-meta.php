...
<?php 
    ...
    <?php edit_post_link( __( '<i class="fa fa-pencil"></i> &nbsp; Edit This Post', 'netfunktheme' ), "<span class=\"meta-sep\"> | </span>\n\t\t\t\t\t\t<span class=\"button tiny round secondary edit-link\">", "</span>\n\t\t\t\t\t" ) ?>

</div>

<?php

	} else if (!isset($netfunk_post_options['show_post_meta'])){ 
...
<div class="entry-meta">
    ...
    <span class="author vcard"><a class="url fn n" href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>" title="<?php printf( __( 'View all articles by %s', 'netfunktheme' ), $authordata->display_name ); ?>"><?php the_author(); ?></a></span>
