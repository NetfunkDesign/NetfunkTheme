...
function theme_options_init(){
  register_setting( 'netfunktheme_general_options', 'netfunktheme_theme_general_options', 'theme_general_options_validate' );
  register_setting( 'netfunktheme_options', 'netfunktheme_theme_options', 'theme_frontpage_options_validate' );
  register_setting( 'netfunktheme_pages_options', 'netfunktheme_theme_pages_options', 'theme_pages_options_validate' );
  register_setting( 'netfunktheme_posts_options', 'netfunktheme_theme_posts_options', 'theme_posts_options_validate' );
  register_setting( 'netfunktheme_css_options', 'netfunktheme_theme_css_options', 'theme_css_options_validate' );
}
...
$script_options = get_option('netfunktheme_theme_css_options');
...
?>
	...
	<div class="wrap netfunktheme-admin">
		...
		<?php settings_fields( 'netfunktheme_options' ); ?>
        <?php $options = get_option( 'netfunktheme_theme_options' ); ?>
         ...
         <table class="form-table">
                ...
                <td>
                	<?php
					    ...
					    foreach ( $onoff_options as $option ) {
                            ...
                            <label class="description"><input type="radio" name="netfunktheme_theme_options[show_welcome_message]" id="netfunktheme_theme_options[show_welcome_message]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
            ...
            <div class="panel radius">
                ...
                <table class="form-table">
                    ...
                    <td>
                        <input type="text" id="netfunktheme_theme_options[welcome_title]" name="netfunktheme_theme_options[welcome_title]" size="40" value="<?php echo (isset($options['welcome_title']) ? $options['welcome_title'] : '' ); ?>"> 
                        <label class="description" for="netfunktheme_theme_options[welcome_title]"><?php _e( 'Your welcome title goes here', 'netfunktheme' ); ?></label>
                    </td>
                </tr>
                <tr valign="top"><th scope="row"><?php _e( ' Welcome message', 'netfunktheme' ); ?></th>
                    <td>
                        <textarea id="netfunktheme_theme_options[welcome_text]" cols="80" rows="10" name="netfunktheme_theme_options[welcome_text]"><?php echo (isset($options['welcome_text']) ? esc_textarea($options['welcome_text']) : '' ) ; ?></textarea> <br  />
                        <label class="description" for="netfunktheme_theme_options[welcome_text]"><?php _e( 'Your welcome message goes here', 'netfunktheme' ); ?></label>
                    </td>
                </tr>
                <tr valign="top"><th scope="row"><?php _e( ' Welcome button title', 'netfunktheme' ); ?></th>
                    <td>
                        <input type="text" id="netfunktheme_theme_options[more_about_title]" name="netfunktheme_theme_options[more_about_title]" value="<?php echo (isset($options['more_about_title']) ? $options['more_about_title'] : '' ); ?>"> 
                        <label class="description" for="netfunktheme_theme_options[more_about_title]"><?php _e( 'Title of the \'more about\' button. Leave empty if you dont want to display it.', 'netfunktheme' ); ?></label>
                    </td>
                </tr>
                <tr valign="top"><th scope="row"><?php _e( ' Welcome button url', 'netfunktheme' ); ?></th>
                    <td>
                        <input type="text" id="netfunktheme_theme_options[more_about_uri]" name="netfunktheme_theme_options[more_about_uri]" value="<?php echo (isset($options['more_about_uri']) ? $options['more_about_uri'] : '' ); ?>"> 
                        <label class="description" for="netfunktheme_theme_options[more_about_uri]"><?php _e( 'The url to you \'about\' page', 'netfunktheme' ); ?></label>
                    </td>
                </tr>
                ...
                <td>
                    <?php
					    ...
					    foreach ( $onoff_options as $option ) {
                            ...
                            <label class="description"><input type="radio" name="netfunktheme_theme_options[show_featured_content]" id="netfunktheme_theme_options[show_featured_content]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
            ...
            <tr valign="top"><th scope="row"><?php _e( ' Show recent posts', 'netfunktheme' ); ?></th>
                <td>
                    <?php
                        ...
                        <label class="description"><input type="radio" name="netfunktheme_theme_options[show_posts_on_home]" id="netfunktheme_theme_options[show_posts_on_home]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
        ...
        <table class="form-table">
            ...
            <tr valign="top"><th scope="row"><?php _e( ' Show page bottom content', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_options[show_front_page_bottom_content]" id="netfunktheme_theme_options[show_front_page_bottom_content]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
          ...
          <table class="form-table">
            ...
            <tr valign="top"><th scope="row"><?php _e( ' Show sidebars', 'netfunktheme' ); ?></th>
              <td>
				...
				?>
                 <label class="description"><input type="radio" name="netfunktheme_theme_options[show_front_page_sidebar]" id="netfunktheme_theme_options[show_front_page_sidebar]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp;
                <?php }  ?>
             </td>
          </tr>
        </table>
        ...
        <table class="form-table">
            <tr valign="top"><th scope="row"><?php _e( ' Show primary sidebar', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_options[show_front_page_primary_sidebar]" id="netfunktheme_theme_options[show_front_page_primary_sidebar]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
          ...
          <tr valign="top"><th scope="row"><?php _e( ' Show secondary sidebar', 'netfunktheme' ); ?></th>
             <td>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_options[show_front_page_secondary_sidebar]" id="netfunktheme_theme_options[show_front_page_secondary_sidebar]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
...
function theme_frontpage_options_validate( $input ) {
...
?>
	...
	<div class="wrap netfunktheme-admin">
		...
		<?php endif; ?>
		<form method="post" action="options.php">
		<?php settings_fields( 'netfunktheme_pages_options' ); ?>
        <?php $options = get_option( 'netfunktheme_theme_pages_options' ); ?>
		<?php theme_nav() ?>
        ...
        <table class="form-table">
            ...
            <tr valign="top">
              <th scope="row"><?php _e( ' Splash type', 'netfunktheme' ); ?></th>
                ...
                <select name="netfunktheme_theme_pages_options[page_splash_type]">
					<?php
        ...
        <table class="form-table">
            ...
            <tr valign="top"><th scope="row"><?php _e( ' Page comments', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_pages_options[show_page_comments]" id="netfunktheme_theme_pages_options[show_page_comments]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
        ...
        <table class="form-table">
            ...
            <tr valign="top"><th scope="row"><?php _e( 'About the author', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_pages_options[show_page_author]" id="netfunktheme_theme_pages_options[show_page_author]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
        ...
        <table class="form-table">
            ...
            <tr valign="top"><th scope="row"><?php _e( ' Page bottom content', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_pages_options[show_page_bottom_content]" id="netfunktheme_theme_pages_options[show_page_bottom_content]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
        ...
        <table class="form-table">
           <tr valign="top">
              <th scope="row"><?php _e( ' Show sidebars', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_pages_options[show_pages_sidebar]" id="netfunktheme_theme_pages_options[show_pages_sidebar]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp;
        ...
        <table class="form-table">
            <tr valign="top"><th scope="row"><?php _e( ' Show primary sidebar', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_pages_options[show_page_primary_sidebar]" id="netfunktheme_theme_pages_options[show_page_primary_sidebar]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp;
          ...
          <tr valign="top"><th scope="row"><?php _e( ' Show secondary sidebar', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_pages_options[show_page_secondary_sidebar]" id="netfunktheme_theme_pages_options[show_page_secondary_sidebar]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp;
...
<?php
} // end theme pages layout options

/* netfunktheme pages options update */
function theme_pages_options_validate( $input ) {
...
?>
	<div class="wrap netfunktheme-admin">
		...
		<?php endif; ?>
		<form method="post" action="options.php">
		<?php settings_fields( 'netfunktheme_posts_options' ); ?>
        <?php $options = get_option( 'netfunktheme_theme_posts_options' ); ?>
		<?php theme_nav() ?>
        ...
        <table class="form-table">
            ...
            <tr valign="top">
              <th scope="row"><?php _e( ' Splash type', 'netfunktheme' ); ?></th>
                ...
                <select name="netfunktheme_theme_posts_options[posts_splash_type]">
					<?php
        ...
        <h3>Posts navigation display type</h3>
            ...
            <tr valign="top"><th scope="row"><?php _e( ' Display type', 'netfunktheme' ); ?></th>
                ...
                <select name="netfunktheme_theme_posts_options[posts_nav_type]">
					<?php
        ...
        <table class="form-table">        
            <tr valign="top"><th scope="row"><?php _e( ' Show top navigation', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_posts_options[show_nav_above]" id="netfunktheme_theme_posts_options[show_nav_above]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
          ...
          <tr valign="top"><th scope="row"><?php _e( ' Show bottom navigation', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_posts_options[show_nav_below]" id="netfunktheme_theme_posts_options[show_nav_below]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
        ...
        <table class="form-table">
            ...
            <tr valign="top"><th scope="row"><?php _e( ' Show author meta', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_posts_options[show_post_meta]" id="netfunktheme_theme_posts_options[show_post_meta]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
        ...
        <table class="form-table">
            ...
            <tr valign="top"><th scope="row"><?php _e( ' Show post meta', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_posts_options[show_post_footer_meta]" id="netfunktheme_theme_posts_options[show_post_footer_meta]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
        ...
        <table class="form-table">
            ...
            <tr valign="top"><th scope="row"><?php _e( ' Show post thumbnail', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_posts_options[show_post_thumbnail]" id="netfunktheme_theme_posts_options[show_post_thumbnail]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
        ...
        <table class="form-table">
            <tr valign="top"><th scope="row"><?php _e( ' Posts comments', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_posts_options[show_post_comments]" id="netfunktheme_theme_posts_options[show_post_comments]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
        ...
        <table class="form-table">
            ...
            <tr valign="top"><th scope="row"><?php _e( 'About the author', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_posts_options[show_post_author]" id="netfunktheme_theme_posts_options[show_post_author]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
        ...
        <table class="form-table">
            ...
            <tr valign="top"><th scope="row"><?php _e( ' Posts bottom content', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_posts_options[show_post_bottom_content]" id="netfunktheme_theme_posts_options[show_post_bottom_content]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
          ...
          <table class="form-table">
            ...
            <tr valign="top"><th scope="row"><?php _e( ' Show sidebars', 'netfunktheme' ); ?></th>
              <td>
				...
				?>
                 <label class="description"><input type="radio" name="netfunktheme_theme_posts_options[show_posts_sidebar]" id="netfunktheme_theme_posts_options[show_posts_sidebar]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp;
                <?php }  ?>
             </td>
          </tr>
        </table>
        ...
        <table class="form-table">
            <tr valign="top"><th scope="row"><?php _e( ' Show primary sidebar', 'netfunktheme' ); ?></th>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_posts_options[show_post_primary_sidebar]" id="netfunktheme_theme_posts_options[show_post_primary_sidebar]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
          ...
          <tr valign="top"><th scope="row"><?php _e( ' Show secondary sidebar', 'netfunktheme' ); ?></th>
             <td>
                ...
                <label class="description"><input type="radio" name="netfunktheme_theme_posts_options[show_post_secondary_sidebar]" id="netfunktheme_theme_posts_options[show_post_secondary_sidebar]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?></label> &nbsp;&nbsp; 
...
<?php
} // end theme posts layout options 

/* netfunktheme posts pages options update */
function theme_posts_options_validate( $input ) {
...
?>
	<div class="wrap netfunktheme-admin">
		...
		<?php endif; ?>
		<form method="post" action="options.php">
		<?php settings_fields( 'netfunktheme_css_options' ); ?>
        <?php $options = get_option( 'netfunktheme_theme_css_options' ); ?>
		<?php theme_nav() ?>
        ...
        <table class="form-table">
           <tr valign="top">
            <th scope="row"><label class="description" for="netfunktheme_theme_css_options[custom_css]"><?php _e( 'CSS Markup', 'netfunktheme' ); ?></label></th>
               <td>
                 <textarea id="netfunktheme_theme_css_options[custom_css]" cols="80" rows="10" name="netfunktheme_theme_css_options[custom_css]" placeholder="Put your custom CSS markup here"><?php echo (isset($options['custom_css']) ? esc_textarea( $options['custom_css']) : ''); ?></textarea>
              </td>
           </tr>
        </table>
		</div>
		...
		<br />
         <table class="form-table">
            <tr valign="top">
            	<th scope="row"><label class="description" for="netfunktheme_theme_css_options[javascript_top]"><?php _e( 'Javascript in Header', 'netfunktheme' ); ?></label></th>
                <td>
                    <textarea id="netfunktheme_theme_css_options[javascript_top]" cols="80" rows="10" name="netfunktheme_theme_css_options[javascript_top]" placeholder="Put your Javascript markup here"><?php echo (isset($options['javascript_top']) ? esc_textarea( $options['javascript_top']) : ''); ?></textarea>
                </td>
            </tr>
        </table>
        <br />
		...
		<br />
         <table class="form-table">
            <tr valign="top">
            	<th scope="row"><label class="description" for="netfunktheme_theme_css_options[javascript_bottom]"><?php _e( 'Javascript in Footer', 'netfunktheme' ); ?></label></th>
                <td>
                   <textarea id="netfunktheme_theme_css_options[javascript_bottom]" cols="80" rows="10" name="netfunktheme_theme_css_options[javascript_bottom]" placeholder="Put your Javascript markup here"><?php echo (isset($options['javascript_bottom']) ? esc_textarea( $options['javascript_bottom']) : ''); ?></textarea>
                </td>
            </tr>
        </table>
        </div>
...
<?php
} // end theme custom css options

/* netfunktheme sutom css options update */
function theme_css_options_validate( $input ) {
	$input['custom_css'] = $input['custom_css'];
	$input['javascript_top'] = $input['javascript_top'];
	$input['javascript_bottom'] = $input['javascript_bottom'];
