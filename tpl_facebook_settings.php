<?
/**
 * Template Name: Facebook API Settings
 * Descripion: netfunkdesign.com / Facebook API Connection Confirmation
 */
...
<span typeof="v:Breadcrumb"><a href="edit-profile" rel="v:url" property="v:title">Member Settings</a></span> &nbsp; <span class="current" typeof="v:Breadcrumb">Facebook - Settings</span>
	...
	try {
		...
		if ($user) {
		  ...
		  echo "<h1>Settings</h1>";
			...
			echo "<div style=\" margin-right: 50px; float: right; text-align: right;\">";

				$params = array('next' => 'http://www.netfunkdesign.com/facebook-close');
