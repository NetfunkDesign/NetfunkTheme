...
class bc_soundcloud_integration {
	...
	function soundcloud_auth_link(){  global $soundcloud;
		...
		. "/plugins/soundcloud-api/soundcloud-api/images/btn-connect-sc-s.png\" class=\"soundcloud_connect\" border=\"0\"/></a>"; }
	...
	function soundcloud_auth_link_mini(){  global $soundcloud;
		...
		. get_template_directory_uri() 
		. "/plugins/soundcloud-api/soundcloud-api/images/btn-connect-s.png\" class=\"soundcloud_connect\" border=\"0\"/></a>"; }
	...
	function soundcloud_disconnect_link(){ 
		...
		. get_template_directory_uri() 
		. "/plugins/soundcloud-api/soundcloud-api/images/btn-disconnect-l.png) no-repeat top left; margin: -10px 0px 0px 20px; width: 140px; height: 29px; border: none;\">";
	...
	function soundcloud_disconnect_link_mini(){ 
		...
		. get_template_directory_uri()
		.'/plugins/soundcloud-api/soundcloud-api/images/btn-disconnect-s.png) no-repeat top left; float: right; margin: 0px 20px 0px 20px; width: 109px; height: 21px; border: none;"></a>';
